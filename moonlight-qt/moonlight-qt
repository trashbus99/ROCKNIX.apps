...
LAUNCH_SCRIPT="$LAUNCH_SCRIPT_DIR/chroot-moonlight.sh"
...
# Install Moonlight-Qt inside the chroot
echo "📦 Installing Moonlight-Qt..."
chroot "$CHROOT_DIR" /bin/bash -l <<EOF
    apk update
    apk add moonlight-qt
EOF

# Generate launch script
echo "📝 Creating Moonlight-Qt launch script..."
...
echo "✅ Moonlight-Qt installed! Run with:"
echo "   $LAUNCH_SCRIPT"
